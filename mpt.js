...
vertex3d.prototype = {
	...
	var textSet = [
		{text:"ARAT", sphereRadius:128, sphereSpace:64, unitTime:128, time:2000},
		{text:"@@@@@@@@", sphereRadius:64 + Math.random()*60, sphereSpace:200, unitTime:100, time:4000},
		{text:"ARIKAN", sphereRadius:128, sphereSpace:64, unitTime:128, time:2000},
		{text:"@@@@@@@@", sphereRadius:64 + Math.random()*60, sphereSpace:200, unitTime:100, time:4000}
	];
	...
	var start = function() {
		...
		setInterval(function() {
			...
			if(invertCV.execution() > 0.7) {
				...
				backgroundColor = "rgba(255,255,255,O.1)";
			} else {
				strokeColor = "rgba(255,255,255,0.1)";
